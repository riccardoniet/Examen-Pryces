...
<header class="text-gray-400 bg-gray-900 body-font">
    ...
    <main class="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <section>
            <h3 class="font-bold text-2xl">Verwijder gegevens</h3>
        </section>

        <section class="mt-10">
            <form class="flex flex-col" method="get" action="/verwijder{{ Auth::user()->id }}">
                {{ csrf_field() }}
                ...
                <button
                    ...
                    type="submit">Verwijder account</button>
            </form>
        </section>
    </main>
